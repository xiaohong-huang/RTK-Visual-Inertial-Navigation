...
bool SppPseudorangeFactor2::Evaluate(double const* const* parameters, double* residuals, double** jacobians) const {
...
bool SppCarrierPhaseFactor2::Evaluate(double const* const* parameters, double* residuals, double** jacobians) const {
    const double* xyz = parameters[0];
    const double* dtgps = parameters[1];
...
bool FixedIntegerFactor2::Evaluate(double const* const* parameters, double* residuals, double** jacobians) const {
...
bool RTKCarrierPhaseFactor2::Evaluate(double const* const* parameters, double* residuals, double** jacobians) const {
    const double* xyz = parameters[0];
...
bool RTKPseudorangeFactor2::Evaluate(double const* const* parameters, double* residuals, double** jacobians) const {
    const double* xyz = parameters[0];
...
bool SppDopplerFactor2::Evaluate(double const* const* parameters, double* residuals, double** jacobians) const {

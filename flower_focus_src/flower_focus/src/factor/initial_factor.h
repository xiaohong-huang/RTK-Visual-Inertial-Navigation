...
class InitialPoseFactor : public SizedCostFunction<6, 7> {
  public:
...
class InitialFactor33 : public SizedCostFunction<3, 3> {
  public:
...
class InitialFactor11 : public SizedCostFunction<1, 1> {
  public:
...
class InitialBlackCeresFactor : public SizedCostFunction<1, 1> {
  public:
...
class InitialBiasFactor : public SizedCostFunction<9, 9> {
  public:

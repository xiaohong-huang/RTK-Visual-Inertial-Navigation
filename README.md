...
```
The [evaluate folder](https://github.com/xiaohong-huang/RTK-Visual-Inertial-Navigation/tree/main/evaluate) includes a demo for evaluating the positioning errors.
## 4. Acknowledgements
